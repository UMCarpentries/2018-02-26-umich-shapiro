...
instructor: ["Gina Baucomb", "Scott Martin", "Marc Sze"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Arthur Endsley", "Zena Lapp", "Srihari Sundar", "Stephanie Thiede"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: "http://pad.software-carpentry.org/2018-02-26-umich-shapiro"            # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
eventbrite: 42642728549          # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
...
<p id="collaborative_notes">
  We will use this <a href="http://pad.software-carpentry.org/2018-02-26-umich-shapiro">collaborative document</a> for chatting, taking notes, and sharing URLs and bits of code.
</p>
{% endif %}
